...
import PodYaml from '!!raw-loader!{{CODE_PATH}}/js/simple-tutorial/generate-manifests/output/manifests/pod-example-app.yaml';
...
import OnModifyPodYaml from '!!raw-loader!{{CODE_PATH}}/js/simple-tutorial/generate-manifests/on-modify/output/manifests/pod-example-app.yaml';
